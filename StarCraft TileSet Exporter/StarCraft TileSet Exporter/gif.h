#pragma once
// 참고: https://overface.tistory.com/694 -> https://github.com/charlietangora/gif-h
...
bool GifBegin(GifWriter* writer, const std::string filename, uint32_t width, uint32_t height, uint32_t delay, int32_t bitDepth = 8, bool dither = false)
{
	...
	writer->f = 0;
	fopen_s(&writer->f, file.c_str(), "wb");
#else
	writer->f = fopen(file.c_str(), "wb");
#endif
